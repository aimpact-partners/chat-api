...
declare namespace ns_0 {
  export enum ErrorCodes {
    ...
    roleNotSupported = 812,
    unauthorizedUserForChat = 813,
    chatNotValid = 814,
    chatWithoutLanguages = 815,
    chatWithoutDefaultLanguage = 816,
    chatWithoutAssociatedProject = 817,
    chatNotHasProjectUrlSet = 818,
    notLanguagesToUpdate = 819,
    llmGenerationError = 820,
    functionExecutionError = 821,
  }
}
