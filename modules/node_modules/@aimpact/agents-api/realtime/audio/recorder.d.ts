...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#23063@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#23063@#permission"?: PermissionStatus;
    "__#23063@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#23063@#error": Error;
    readonly error: Error;
    "__#23063@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#23063@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#22478@#private": any;
