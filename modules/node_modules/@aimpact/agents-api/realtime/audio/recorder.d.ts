...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#52915@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#52915@#permission"?: PermissionStatus;
    "__#52915@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#52915@#error": Error;
    readonly error: Error;
    "__#52915@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#52915@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#22469@#private": any;
