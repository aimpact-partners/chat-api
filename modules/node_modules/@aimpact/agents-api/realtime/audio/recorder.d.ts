...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#45682@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#45682@#permission"?: PermissionStatus;
    "__#45682@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#45682@#error": Error;
    readonly error: Error;
    "__#45682@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#45682@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#22550@#private": any;
