...
declare namespace ns_3 {
  ...
  export const permissions: {
    "__#45544@#ready": PendingPromise<void>;
    readonly ready: PendingPromise<void>;
    "__#45544@#permission"?: PermissionStatus;
    "__#45544@#state": IPermissionState;
    readonly state: IPermissionState;
    "__#45544@#error": Error;
    readonly error: Error;
    "__#45544@#set"(state: IPermissionState): void;
    /**
     * Not available in Safari
     */
    "__#45544@#onchange"(status: PermissionStatus): void;
    request(): Promise<void>;
    release(): void;
    "__#22555@#private": any;
