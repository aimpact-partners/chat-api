...
declare namespace ns_0 {
  ...
  export class User implements IUser {
    ...
    register(user: IUsersData): Promise<BusinessResponse<unknown>>;
    login(user: IUsersData): Promise<BusinessResponse<unknown>>;
    toJSON(): IUser;
  }
}
